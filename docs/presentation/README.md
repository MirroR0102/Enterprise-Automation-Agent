...
| 文件 | 说明 |
| --- | --- |
| `第4部分-企业业务流程自动化Agent-汇报.pptx` | 22 页演示幻灯片（少字多图，v2 重排版） |
| `第4部分-企业业务流程自动化Agent-演讲稿.pdf` | ≈30 分钟口语完整稿（7 页，含【动作】/减配加餐/附录备答） |
| `第4部分-企业业务流程自动化Agent-报告执行说明.pdf` | 汇报人控场用（不要念，4 页） |
| `第4部分-企业业务流程自动化Agent-报告执行说明.md` | 执行说明 Markdown 源（可进 git） |

> **2026-09-16 v2：** 旧版 20 页 PPT/短讲稿因质量不足被用户整体否决，已按范本（`reference-contract-ai/`）的结构密度重做本目录全部材料；旧版产物已被覆盖。
